	...
	public class Teleport : MonoBehaviour
    {
		...
		private void TeleportPlayer()
		{
			...
			if ( teleportingToMarker.ShouldMovePlayer() )
			{
                ...
                player.trackingOriginTransform.position = new Vector3((teleportPosition + playerFeetOffset).x, player.trackingOriginTransform.position.y, (teleportPosition + playerFeetOffset).z);
            }
			else
			{
        ...
        //public static implicit operator Teleport(Teleportscript v)
        //{
